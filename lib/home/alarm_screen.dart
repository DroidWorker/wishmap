                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text("Пока будильников нет",
                              style: TextStyle(
                        ...
                        children: [
                          Expanded(
                            child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return ReminderItem(
                                    alarms[index],
                                    outlined: deleteQueue.contains(index),
                                    onTap: (id) {
                                      if (deleteMode) {
                                        setState(() {
                                          if (deleteQueue.contains(index)) {
                                            deleteQueue.remove(index);
                                          } else {
                                        ...
                                        BlocProvider.of<NavigationBloc>(context)
                                            .add(
                                                NavigateToAlarmSettingsScreenEvent(
                                                    alarms[index].id));
                                      }
                                    },
                                    onChangeState: (id, state) async {
                                      final alarm =
                                          (alarms.firstWhere((e) => e.id == id)
                                            ..remindEnabled = state);
                                      if (state) {
                          ...
                          deleteMode
                              ? ColorRoundedButton("Удалить", () {
                                deleteQueue = deleteQueue.sorted((a,b)=> b.compareTo(a));
                              ...
                              : FloatingActionButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    BlocProvider.of<NavigationBloc>(context)
                                        .add(NavigateToAlarmSettingsScreenEvent(
                                            id));
                                  },
                                  child: Container(
                                    width: 50,
