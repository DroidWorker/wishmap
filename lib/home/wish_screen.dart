                                  ...
                                  child: IconButton(
                                    ...
                                    if(isParentHidden){
                                      ...
                                      showModalBottomSheet<void>(
                                        ...
                                        isScrollControlled: true,
                                        builder: (BuildContext context) {
                                          return NotifyBS('Внимание', "Превышено количество 'Желаний на орбите'. Максимальное количество желаний на орбите 12 шт. Вы можете скрть или удалитьдругие желания, чтобы освободить место для демонстрации данного желания на орбите", 'OK',
                                              onOk: () => Navigator.pop(context, 'OK'));
                                        },
                                      );
                                    }else {
